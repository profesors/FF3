...
\renewcommand{\spanishabstractname}{Preámbulo}
\renewcommand{\spanishfigurename}{Gráfico}

\pagestyle{fancy}           % Cabecera de cada página
\fancyhf{}
\fancyhead[C]{Fundamentos de Física III. Soluciones exámenes curso 2014-2015}
\fancyfoot[C]{\thepage}
